...
-   **Vert.x**: This is a toolkit for building reactive applications on
    a JVM ([vertx.io]).
...
To make the coding easier in practice, there is an abstract
...
For an HTTP [POST] request, we expect a payload in the JSON format
